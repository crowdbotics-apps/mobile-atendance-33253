...
## Project Structure
    ...
    ├── mobile_atendance_33253  # Django project configurations
...
1. Clone this repo and `cd mobile_atendance_33253`
...
2. Clone this repo and `cd mobile_atendance_33253`
